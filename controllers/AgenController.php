...
use Yii;
use app\models\Agen;
use app\models\AgenSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AgenController implements the CRUD actions for Agen model.
 */
class AgenController extends Controller
{
    ...
    /**
     * Lists all Agen models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new AgenSearch();
    ...
    /**
     * Updates an existing Agen model.
    ...
    /**
     * Deletes an existing Agen model.
    ...
    /**
     * Finds the Agen model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Agen the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Agen::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Id Supervisor');
        $sheet->setCellValue('C3', 'Nama');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data Agen');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->id_supervisor);
