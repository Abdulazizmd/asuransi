...
<div class="login-box">
    ...
    <div class="login-logo">
        <img src="<?php echo Yii::$app->request->baseUrl; ?>/images/logo-pangandaran.png" style="width: 100px">
        <br>
        <font style="stroke" size="5"><b>WFH Dispusip <br> Kabupaten Pangandaran</b></font>
    </div>
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                ...
                <?= $form->field($model, 'username')->textInput(['autofocus' => true,'placeholder' => 'Username / Email'])->label(false) ?>
